...
import com.tools.hutoolalike.enums.area.AreaTypeEnum;
...
import static com.tools.hutoolalike.utils.CollectionUtils.convertList;
import static com.tools.hutoolalike.utils.CollectionUtils.findFirst;
...
public class AreaUtils {
    ...
    private AreaUtils() {
        ...
        areas.put(Area.ID_GLOBAL, new Area(Area.ID_GLOBAL, "全球", 0,
                null, new ArrayList<>()));
        // 从 csv 中加载数据
        List<CsvRow> rows = CsvUtil.getReader().read(ResourceUtil.getUtf8Reader("static/area.csv")).getRows();
